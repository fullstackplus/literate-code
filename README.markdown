...
6. A Table of Contents is a <code>div</code> tagged with the class "toc". A good place for it is right after the main essay title.
...
More tags of the recent kind (itemprop, property, author) for cutting-edge SEO